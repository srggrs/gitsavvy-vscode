...
An adaptation of [GitSavvy](https://github.com/timbrel/GitSavvy) (Sublime Text) to Visual Studio Code and Visual Studio Codium. Keyboard-driven git integration with a plain-text status dashboard.
